"""
Generate the cooperation agreement draft (v4) between Blue Ocean Group (Party A)
and Xiamen University (Party B).

v4 changes (relative to user-edited v3):
  - Title broadened from "闽投一号海洋科研合作框架协议" to
    "海洋科技战略合作框架协议" — agreement now reflects strategic cooperation
    between the two institutions, with 闽投一号 positioned as the FIRST/initial
    cooperation carrier rather than the sole scope.
  - Preamble reframed to introduce long-term strategic cooperation, with
    Mintou-1 as the first concrete carrier.
  - (一) 合作原则与共识: new opening principle that establishes the
    strategic-partnership framing.
  - (二) 合作平台名称 renamed to (二) 首期合作平台 + 基地名称, allowing
    future expansion to additional platforms/areas.
"""
...
add_blank(doc)
add_title(doc, "海洋科技战略合作", size=20)
...
# Preamble (reframed: strategic cooperation between two institutions,
# Mintou-1 as the first carrier)
add_body(doc,
    ...
    "经友好协商，决定建立长期、稳定、全面的海洋科技战略合作伙伴关系，"
    "围绕海洋科技创新、海洋产业升级、人才培养与国际科研合作等领域开展全方位合作。"
    "首期合作以甲方战略性资产——\"闽投一号\"深远海智能养殖平台为载体，"
    "共同推动ONCE国际大科学计划"
    "（Ocean Negative Carbon Emissions，海洋负排放国际大科学计划）"
    "在中国的落地，将闽投一号建设为ONCE国际大科学计划在华创新科研基地，"
    "围绕海洋环境智能监测、水域净化与生态修复、水下巡检与数据采集等方向开展科研合作，"
    "推动\"国际科研方法学 × 中国海洋场景\"对接验证；"
    "在闽投一号合作积累与验证基础上，"
    "双方可视进展逐步拓展至更广泛的海洋科技与海洋产业领域，"
...
add_body(doc,
    "1. 双方在自愿、平等、互利、共赢的基础上，建立长期、稳定、全面的海洋科技战略合作伙伴关系，"
    "围绕海洋科技、海洋产业、人才培养、国际合作等领域，全方位推进产学研用深度融合，"
    "形成优势互补、利益共享的合作共同体。")
add_body(doc,
    "2. 双方深刻认识加快建设海洋强国、发展海洋经济的重要意义，"
    "积极落实国家和福建省关于海洋科技创新、深远海养殖与海洋生态保护的决策部署。"
    "首期合作以闽投一号深远海智能养殖平台为载体，全方位推进闽投一号上的科研合作与成果转化；"
    "在合作积累与验证基础上，双方可视进展逐步拓展至其他海洋科技、海洋产业相关领域。")
add_body(doc,
    "3. 充分发挥甲方依托闽投一号等核心资产形成的深远海养殖与海洋牧场产业优势，"
    "以及乙方作为国家\"双一流\"建设高校的科研平台优势，"
    "积极探索产学研用深度融合的新模式。")
add_body(doc,
    "4. 双方一致同意，将闽投一号建设为兼具国际科研体系背书与中国海洋场景验证能力的"
    "合作示范平台，打造中国深远海科研合作的物理载体与品牌窗口。")

add_heading_cn(doc, "（二）首期合作平台", level=2)
add_body(doc,
    "双方首期合作依托甲方\"闽投一号\"深远海智能养殖平台开展，"
    "共建\"蔚蓝海洋集团—厦门大学闽投一号海洋科研合作基地\"（以下简称\"基地\"），"
    "作为双方战略合作的首个落地载体。"
    "未来双方可根据合作推进情况，在本协议框架下共建其他海洋科技合作平台或基地，"
    "具体安排由双方另行书面约定。")
...
add_body(doc,
    ...
    "包括但不限于：蓝碳方法学研究与海洋碳汇核算，"
    "以监测数据为依据的绿色金融产品（绿色债券、海洋保险、ESG评估等）理论研究与可行性评估，"
    "面向海渔、生态环境等主管部门的长期数据服务方案研究。")
...
add_body(doc,
    "发挥双方在深远海养殖装备、海洋观测仪器、水下机器人、海洋大数据与人工智能等领域的"
    "技术积累与产业资源，共同开展面向闽投一号及未来同类平台的技术研究与产品开发，"
    "并可根据需要拓展至其他海洋科技领域。")
...
add_body(doc,
    "乙方依托海洋、生态、信息、管理等跨学科专业优势，"
    "面向甲方及福建省海洋经济相关企业从业人员，"
...
add_body(doc,
    ...
    "开放用于基地的科研合作，作为甲方在本协议项下首期合作的主要投入；"
    "具体使用安排、作业窗口、安全保障与配套服务由双方在子协议中另行约定；")
add_body(doc,
    "2. 在甲方主营业务允许的范围内，向基地提供闽投一号平台的运营数据、生产数据"
    "及其他与合作方向相关的产业数据，支持联合科研工作的开展；")
add_body(doc,
    "3. 配合乙方推进ONCE国际大科学计划在闽投一号相关合作事项的对接与落地；")
add_body(doc, "4. 负责基地科研活动在闽投一号现场实施的统筹协调、安全管理与后勤保障；")
add_body(doc,
    "5. 将基地的项目成果及产业化进展定期向乙方反馈，"
    "并就工程化落地与产业化推广提供产业资源对接；")
...
add_body(doc,
    ...
    "及科研监测数据均承担保密义务。未经对方书面许可，"
    "任何一方不得擅自披露对方的技术资料和商业信息，"
...
# Signing page
p = add_heading_cn(doc, "签 署 页", level=1)
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
...
out_path = os.path.join(os.path.dirname(__file__),
                       "蔚蓝海洋集团-厦门大学-海洋科技战略合作框架协议（草案）.docx")
doc.save(out_path)
