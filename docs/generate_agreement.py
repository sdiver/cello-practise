...
add_body(doc,
    ...
    "以及福建省关于深远海养殖、海洋牧场和蓝色碳汇等相关政策导向，双方本着优势互补、合作共赢的原则，"
    "充分发挥甲方在海洋科学、生态学、信息工程及国际科研合作方面的学科与人才优势，"
    "以及乙方在深远海养殖装备、海洋牧场运营和海洋产业资源整合方面的产业优势，"
    "依托乙方战略性资产——\"闽投一号\"深远海智能养殖平台，"
    "共同开展海洋环境智能监测、水域净化与生态修复、水下巡检与数据采集等领域的科研合作，"
    "推动\"国际科研方法学 × 中国海洋场景\"对接验证，"
    "服务福建省海洋经济高质量发展，经友好协商，特签订本框架协议。")
...
add_body(doc,
    "2. 充分发挥甲方作为国家\"双一流\"建设高校的科研平台优势（含近海海洋环境科学国家重点实验室、"
    "海洋与地球学院、生命科学学院、环境与生态学院、信息学院等），以及乙方依托闽投一号"
    "等核心资产形成的深远海养殖与海洋牧场产业优势，积极探索产学研用深度融合的新模式，"
    "形成优势互补、利益共享的合作共同体。")
add_body(doc,
    "3. 双方共同将\"闽投一号\"建设为面向海洋牧场与深远海养殖场景的科研合作示范平台，"
    "并积极对接ONCE国际大科学计划等国际科研体系，努力将其打造为中国深远海科研合作的物理载体与品牌窗口。")

add_heading_cn(doc, "（二）合作平台名称", level=2)
add_body(doc, "厦门大学—蔚蓝海洋闽投一号海洋科研合作基地（以下简称\"基地\"）。")

add_heading_cn(doc, "（三）合作方向", level=2)

add_heading_cn(doc, "1. 海洋环境智能监测", level=3)
add_body(doc,
    "依托甲方在海洋环境观测、海洋生态学、水声学、海洋传感与遥感、海洋大数据等领域的学科优势，"
    "结合乙方闽投一号现有平台及周边海域，联合开展水文、水质、生物、气象等多要素长期在线监测系统建设，"
    "形成可复用、可扩展的深远海智能监测体系。")
...
add_heading_cn(doc, "（四）合作形式与内容", level=2)

add_heading_cn(doc, "1. 在校学生培养", level=3)
add_body(doc,
    "乙方为甲方师生提供闽投一号现场科研实习与实践基地，每年安排2周、4周、6周等时间不等的现场实习。"
    "实习内容包括但不限于：海洋环境监测实践、深远海养殖科学实践、水下装备测试与数据采集实践等。"
    "甲方围绕海洋经济与深远海产业关键技术，结合现场需求，编写教材教案、开展课程实践。")
add_body(doc,
    "乙方可为甲方在读研究生提供研究课题，并委派技术骨干作为校外导师；"
    "可为甲方在读研究生提供毕业设计指导。甲方优先推荐毕业生到乙方就业，"
    "乙方优先招聘双方联合培养的、符合招聘条件的研究生。")

add_heading_cn(doc, "2. 产业人才培训", level=3)
add_body(doc,
    "甲方依托海洋、生态、信息、管理等跨学科专业优势，面向乙方及福建省海洋经济相关企业从业人员，"
    "提供覆盖海洋观测、生态修复、智能装备、数据治理、蓝碳与绿色金融等多层次、跨学科的产业人才培训，"
    "助力乙方及海洋经济生态培养复合型、专业型人才。")
...
add_heading_cn(doc, "（五）合作推进机制", level=2)
add_body(doc,
    "双方以紧密合作、加快推进为目标，共同组建闽投一号海洋科研合作基地建设联合领导小组。"
    "甲方指定国内合作办公室为对口联系部门，乙方指定        为对口联系部门，"
    "负责合作的统一协调、管理工作，推动合作事项并组织实施。")

# Section 2: Organizational structure
add_heading_cn(doc, "二、组织结构", level=1)

add_heading_cn(doc, "（一）组织机构", level=2)
add_body(doc,
    "1. 闽投一号海洋科研合作基地为非独立法人机构，由甲乙双方在本协议指导下共同管理和运作。")
add_body(doc,
    "2. 甲方依托海洋与地球学院、近海海洋环境科学国家重点实验室、环境与生态学院、"
    "生命科学学院、信息学院、国内合作办公室等开展工作；"
    "乙方依托闽投一号项目公司及相关业务部门开展工作。"
    "后续可根据需求经双方协商确定引入其他方参与共建。")
add_body(doc, "3. 基地设立管理委员会和办公室。")

add_heading_cn(doc, "（二）管理委员会", level=2)
add_body(doc,
    "管理委员会负责审议基地合作内容；审议基地年度研究目标和工作总结；审议基地管理规章制度；"
    "对基地经费投入、保障措施等重大事务做出决策；协调解决实施过程中的重大问题。")
add_body(doc, "管理委员会由甲乙双方派员共同组成，成员包括：")
add_body(doc, "甲方指派人员（拟）：")
add_body(doc, "    1) 厦门大学     （分管副校长）")
add_body(doc, "    2) 厦门大学国内合作办公室     （主任）")
add_body(doc, "    3) 厦门大学海洋与地球学院     （院长/副院长）")
add_body(doc, "    4) 厦门大学环境与生态学院     （院长/副院长）")
add_body(doc, "    5) 厦门大学信息学院     （院长/副院长）")
add_body(doc, "乙方指派人员（拟）：")
add_body(doc, "    1) 蔚蓝海洋集团有限公司     （主要负责人）")
add_body(doc, "    2) 蔚蓝海洋集团     （分管科研/产业负责人）")
add_body(doc, "    3) 闽投一号项目公司     （主要负责人）")

add_heading_cn(doc, "（三）办公室", level=2)
add_body(doc,
    "办公室负责基地的日常管理和运行，负责制定基地各项管理规章制度，"
    "负责活动组织、人才培养和学术交流等综合管理工作。")
add_body(doc, "主    任：     ")
add_body(doc, "副 主 任：     ")
add_body(doc, "成    员：     ")
add_body(doc, "若一方对管理委员会和办公室的派员有变动时，须及时以书面形式通知另一方。")
...
add_body(doc,
    "5. 闽投一号现场所产生的监测数据，原则上由乙方持有并管理，甲方依研究目的依规使用；"
    "用于公开发表、对外披露或商业化应用前，应取得乙方书面同意。")
...
add_body(doc, "3. 牵头组织联合申报国家级、省部级重点科研课题；")
add_body(doc, "4. 明确支持基地建设的技术专家团队，并为双方联合培养研究生提供研究课题；")
add_body(doc, "5. 负责联合研发成果的对外学术发布与共同推广。")

add_heading_cn(doc, "（二）乙方责任", level=2)
add_body(doc,
    "1. 乙方将闽投一号深远海智能养殖平台、相关海域作业场地、配套设施及必要的现场作业资源"
    "开放用于基地的科研合作，作为乙方在本协议项下的主要投入；"
    "具体使用安排、作业窗口、安全保障与配套服务由双方在子协议中另行约定；")
add_body(doc,
    "2. 在乙方主营业务允许的范围内，向基地提供闽投一号平台的运营数据、生产数据"
    "及其他与合作方向相关的产业数据，支持联合科研工作的开展；")
add_body(doc, "3. 负责基地科研活动在闽投一号现场实施的统筹协调、安全管理与后勤保障；")
add_body(doc, "4. 将基地的项目成果及产业化进展定期向甲方相关部门进行反馈，并就工程化落地与产业化推广提供产业资源对接；")
add_body(doc, "5. 根据甲方对建设成果的意见，配合制订相应改进方案，完善成果；")
add_body(doc,
    "6. 明确乙方委派支持基地建设的技术骨干，并根据项目执行情况推荐联合培养的"
    "在读全日制和非全日制研究生，具体人数双方协商确定；")
add_body(doc,
    "7. 如双方就特定课题约定需追加专项经费或现金投入，由双方另行签订书面协议确定，"
    "并按相应协议管理使用。")
...
add_blank(doc)
add_body(doc, "甲方：厦门大学（盖章）", indent=False)
...
add_body(doc, "乙方：蔚蓝海洋集团有限公司（盖章）", indent=False)
add_body(doc, "法定代表人/授权代表：", indent=False)
add_body(doc, "联系人：", indent=False)
add_body(doc, "地址：", indent=False)
add_body(doc, "联系电话：               传真：               ", indent=False)
...
out_path = os.path.join(os.path.dirname(__file__),
                       "厦门大学-蔚蓝海洋集团-闽投一号海洋科研合作框架协议（草案）.docx")
doc.save(out_path)
